...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.52ffb433e4e7b5a1e6dab1d9c511b648b7f35edca54da736ffddd21746c4692d.js',function(){input.required=false;search();});}
