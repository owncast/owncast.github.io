...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.0725c15366327f251de852d27da6eb8f57dd3976aedaf003464ccdcb1b9689ff.js',function(){input.required=false;search();});}
