...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.4016a354e9e1268d0c04ffd435efc05270194b22ed083acbd431cefec286c6f1.js',function(){input.required=false;search();});}
