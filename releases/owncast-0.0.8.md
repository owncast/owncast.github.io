...
View all downloads on the [GitHub release page](https://github.com/owncast/owncast/releases/tag/v0.0.8).

| Platform | Download |
|----------|----------|
| owncast-0.0.8-linux-32bit.zip | [Download](https://github.com/owncast/owncast/releases/download/v0.0.8/owncast-0.0.8-linux-32bit.zip) (13.4 MB) |
| owncast-0.0.8-linux-64bit.zip | [Download](https://github.com/owncast/owncast/releases/download/v0.0.8/owncast-0.0.8-linux-64bit.zip) (13.8 MB) |
