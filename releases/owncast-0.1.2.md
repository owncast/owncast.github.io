...
View all downloads on the [GitHub release page](https://github.com/owncast/owncast/releases/tag/v0.1.2).

| Platform | Download |
|----------|----------|
| owncast-0.1.2-linux-32bit.zip | [Download](https://github.com/owncast/owncast/releases/download/v0.1.2/owncast-0.1.2-linux-32bit.zip) (16.5 MB) |
| owncast-0.1.2-linux-64bit.zip | [Download](https://github.com/owncast/owncast/releases/download/v0.1.2/owncast-0.1.2-linux-64bit.zip) (17.2 MB) |
| owncast-0.1.2-linux-arm64.zip | [Download](https://github.com/owncast/owncast/releases/download/v0.1.2/owncast-0.1.2-linux-arm64.zip) (16.2 MB) |
