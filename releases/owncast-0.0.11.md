...
View all downloads on the [GitHub release page](https://github.com/owncast/owncast/releases/tag/v0.0.11).

| Platform | Download |
|----------|----------|
| owncast-0.0.11-linux-32bit.zip | [Download](https://github.com/owncast/owncast/releases/download/v0.0.11/owncast-0.0.11-linux-32bit.zip) (13.5 MB) |
| owncast-0.0.11-linux-64bit.zip | [Download](https://github.com/owncast/owncast/releases/download/v0.0.11/owncast-0.0.11-linux-64bit.zip) (14.4 MB) |
