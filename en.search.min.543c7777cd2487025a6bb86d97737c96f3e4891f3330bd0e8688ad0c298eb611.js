...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.191223290675ea6d1886f97a7a375cbb6cec8ffd1ef6748c14dd43b473354b40.js',function(){input.required=false;search();});}
