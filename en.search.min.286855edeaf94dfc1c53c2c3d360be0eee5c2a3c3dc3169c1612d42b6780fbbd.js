...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6127a4d67bd051d114655b1800502ecf32563ceeb76043d6fedcf4cbf0d29b2d.js',function(){input.required=false;search();});}
