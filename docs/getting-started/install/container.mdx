...
Owncast 0.3.0 features such as [plugins](/docs/plugins) are only in the nightly image, `ghcr.io/owncast/owncast:nightly`. The stable image is `owncast/owncast:latest` on Docker Hub.
:::
