...
- Python 3.8 or newer, and [`uv`](https://docs.astral.sh/uv/) or `pip` to install the `owncast-plugin-sdk` toolchain.
...
Install the SDK from PyPI to get the `owncast-plugin-py` CLI, then scaffold a project with `new`:
