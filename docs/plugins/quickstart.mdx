...
- Python 3.8 or newer, and [`uv`](https://docs.astral.sh/uv/) or `pip` to install the `owncast-plugin-py` toolchain.
...
<img
  src="/docs/img/plugin-permissions-tab.png"
  alt="The Permissions tab on a plugin's detail page, listing each requested permission with a plain-language description"
  width="80%"
/>
