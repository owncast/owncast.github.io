...
Use `msg.timestamp` when you need wall-clock time. The SDK examples and author guide both call out that the sandbox's local clock is frozen, so timestamps on incoming events are your source of truth.
