...
If your plugin responds to chat commands, declare a command table rather than parsing the prefix yourself. The host routes commands and answers `!help` automatically, and you can still layer your own chat handlers on top. See [Chat commands](/docs/plugins/commands).
