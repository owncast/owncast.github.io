...
`/api/config`, and the rest of the public web surface require login. Owncast's
admin pages keep their own admin authentication so an operator can always
disable a broken gate.
