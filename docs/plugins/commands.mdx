...
<img
  src="/docs/img/plugin-help-command.png"
  alt="The !help response in chat, listing the commands an enabled plugin provides with their descriptions, grouped by plugin"
  width="320"
/>
