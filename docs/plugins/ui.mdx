...
See [Handlers: page content](/docs/plugins/handlers#onpagecontent-slug-user) for the payload shape. The viewer identity is present when the viewer is authenticated and absent for anonymous viewers.
...
See [Handlers: tab content](/docs/plugins/handlers#ontabcontent-slug-user) for the payload shape. The viewer identity is present when authenticated and absent for anonymous viewers.
