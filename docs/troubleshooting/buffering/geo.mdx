...
import RelocatePhysicalServer from '../../troubleshooting/shared/relocate-physical-server.md';
import AddLowerQualityOutputs from '../../troubleshooting/shared/add-lower-quality-outputs.md';
