...
The standalone chat URL lives at: `http://owncast.example.com/embed/chat/readwrite`.
...
The read-only chat URL lives at: `http://owncast.example.com/embed/chat/readonly`.
