...
1. Set up Owncast and configure it by your choosing. Since the RTMP stream comes directly from the Zoom servers, at least the RTMP port should be available from the internet.
