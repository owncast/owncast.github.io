...
Zoom sends its RTMP stream from the internet, so TCP port 1935 on your Owncast server must be publicly reachable. Have your stream key ready.

1. Set up Owncast and configure it by your choosing.
