...
Restream sends its RTMP stream from the internet, so TCP port 1935 on your Owncast server must be publicly reachable. Have your stream key ready.

1. Login and go to the "Add Channel" screen.
![Add Channel Screen](/docs/img/restream1.png)

1. Select "Custom RTMP"
![Select Custom RTMP](/docs/img/restream2.png)

1. Add your server information in the format of `rtmp://myserver/live` for the RTMP URL and your Stream Key.
![Server Information](/docs/img/restream3.png)
