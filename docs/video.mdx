---
title: Choose the Right Video Quality Settings
description: Configure your video to manage the quality and hardware performance.
sidebar_position: 400
sidebar_label: Choose the right video quality settings
---
...
By default viewers press play to start watching. If you would rather the stream start on its own when someone opens your page, change the **Autoplay** setting on the same Video configuration page. It has no performance impact, and it applies to your Owncast page and to [embedded players](/docs/embed#autoplay).

<img
  src="/docs/img/admin-autoplay.png"
  alt="The Autoplay setting on the Video configuration page in the admin, showing the behavior dropdown"
  width="65%"
/>
...
:::warning[This is an advanced setting that most people should not use.]
...
Read more about [configuring your broadcasting software](/docs/broadcasting/obs).
