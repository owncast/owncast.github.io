...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.dcd4111df35ce8abb481cbcf173c2e317adc981889795f9e41088442294422fa.js',function(){input.required=false;search();});}
