...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.0e9f7b828a2bde09cd4897b2b861e9974b438cf2c9181cd74dcf7897b58107be.js',function(){input.required=false;search();});}
