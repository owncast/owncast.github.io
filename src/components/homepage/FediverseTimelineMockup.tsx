...
const POSTS: Post[] = [
  ...
  },
  {
    ...
    text: translate({
      ...
      message: "Starting up tonight's stream! Get over here, we're playing some Cat-tar Hero! 🎸",
    }),
    tags: ['#gaming', '#streaming'],
    link: 'https://owncat.gaming',
    imageSrc: '/images/screenshots/owncat-streaming.png',
    replies: 8,
    boosts: { count: 23 },
