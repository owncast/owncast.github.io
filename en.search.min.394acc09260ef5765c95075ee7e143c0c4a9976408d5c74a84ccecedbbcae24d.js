...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f6a10bac922b805d38cd53ec09e4acc387322e40fbc42a6e4f65e61bc7d083a3.js',function(){input.required=false;search();});}
