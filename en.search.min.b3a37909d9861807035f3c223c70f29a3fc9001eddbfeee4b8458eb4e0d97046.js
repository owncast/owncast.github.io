...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.136be741a98bca895d3fd72dd5e9d6ed766f46b0e32de2a76c5ab80581ff5ea3.js',function(){input.required=false;search();});}
