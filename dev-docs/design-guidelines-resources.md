...
Read the detailed product overview to learn more about the product and who it's for.
...
**Knowledge:** Intermediate to advanced understanding of setting up a server.

- Individual content creator hobbyist • stream: mixed
  - video gamers • stream: public
  - Casual "hang out and chat" • stream: public
  - Community group events • stream: private
- Organizations • stream: public/private
  - Business professionals (e.g. 24/7 TV streams)
  - Non-profits (e.g. churches)

## 🧑‍🎨 Product design opportunities

Owncast is a constantly moving project with features both old and new. This allows for design contributions to be both big or small. You may not know how much time you can dedicate to the project, or if you'll be able to see something through to the end, so be honest about that. Take on projects that you'll be able to see completed.
...
- If you think you'll be around longer term, learn about future new features and start thinking about the design challenges of those so we can build them with your feedback and design contributions in mind. See your designs put in the world through brand new functionality!
- Not everything has to be a feature. Think big picture. What can we start doing now to put the project in a better place six months from now, or a year?

## Where to start?

1. You can see a collection of design materials under the "style" section of our "Storybook" [here](https://owncast.online/components) and some additional notes and resources in the Design Guidelines & Resources.
2. Check out open [issues](https://github.com/owncast/owncast/issues?q=is%3Aopen+is%3Aissue+label%3A%22needs+design%22) on GitHub (we label them with `needs design`)
3. Feel free to open an issue on your own if there is something else you would like to contribute to the project.
4. Add your thoughts to an issue, and we promise we will review your thoughts carefully and foster discussions.
5. Once discussion takes place, and all is agreed upon, design can begin in our [PenPot organization](https://design.penpot.app/#/dashboard/team/8373f780-f255-11ec-b774-f940e3befd53/projects). It's much like Figma, but is free and open source. Ask Gabe for edit access.
...
We do not currently have any design files that fully represent the state of the Owncast interface. However, going forward, it would be nice to resolve this and collaborate on designs.
...
All design work is licensed under the [MIT](https://mit-license.org/) license.