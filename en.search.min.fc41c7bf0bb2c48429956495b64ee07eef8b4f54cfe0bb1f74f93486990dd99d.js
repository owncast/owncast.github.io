...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.32b3b166e0f03805bccefad8a5fd63a8d9ba8ea7d2a4747abb15ab34178044d5.js',function(){input.required=false;search();});}
