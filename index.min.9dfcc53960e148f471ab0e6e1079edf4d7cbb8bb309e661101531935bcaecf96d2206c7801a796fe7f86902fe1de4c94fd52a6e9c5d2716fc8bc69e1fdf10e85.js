...
\u003cdiv style="text-align: center;"\u003e
    ...
    \u003c/figure\u003e
    \u003c/div\u003e
`},{id:2,href:"/docs/storage/digitalocean/",title:"Digital Ocean Spaces",description:"250 GB storage + 1 TB Outbound Transfer for $5/mo.",content:`\u003cp\u003e250 GB storage + 1 TB Outbound Transfer for $5/mo.\u003c/p\u003e
...
`},{id:3,href:"/docs/storage/wasabi/",title:"Wasabi",description:"*no longer recommended* $5.99/mo with no additional costs for the amount of people or amount of times people access your video.",content:`\u003cp\u003ePlease read the following \u003ca href="https://wasabi-support.zendesk.com/hc/en-us/articles/360000451052-Can-I-use-Wasabi-to-host-my-videos-"\u003elink\u003c/a\u003e before using.\u003c/p\u003e
\u003cul\u003e
...
\u003cul\u003e
\u003cli\u003eEndpoint: Is the \u0026ldquo;service URL\u0026rdquo; you looked up above, likely \u003ccode\u003ehttps://s3.wasabisys.com\u003c/code\u003e or similar (Don\u0026rsquo;t forget to include \u0026ldquo;https://\u0026rdquo;)\u003c/li\u003e
...
\u003cblockquote\u003e
\u003cp\u003e\u003cfont size="2.5" color="#ff0f0f"\u003e \u003cstrong\u003e⚠️  This provider doesn\u0026rsquo;t currently support object lifecycles so if you don\u0026rsquo;t handle the deletion of unused objects yourself you\u0026rsquo;ll be paying for more storage than necessary.\u003c/strong\u003e\u003c/font\u003e\u003c/p\u003e
\u003c/blockquote\u003e
...
\u003col\u003e
\u003cli\u003e
\u003cp\u003eBefore creating a bucket, you have to purchase the R2 plan in the Cloudflare dahboard \u003ca href="https://www.cloudflare.com/pg-lp/r2/"\u003ePurchase R2\u003c/a\u003e\u003c/p\u003e
\u003c/li\u003e
\u003cli\u003e
\u003cp\u003eClick on R2 in the dashboard or go to \u003ca href="https://dash.cloudflare.com/%7BACCOUNT_ID%7D/r2"\u003ehttps://dash.cloudflare.com/{ACCOUNT_ID}/r2\u003c/a\u003e\u003c/p\u003e
\u003c/li\u003e
\u003cli\u003e
\u003cp\u003eEnter your preferred unique bucket name \u0026gt; Click \u0026ldquo;Create bucket\u0026rdquo;\u003c/p\u003e
\u003c/li\u003e
\u003c/ol\u003e
\u003ch2 id="generate-an-s3-auth-token"\u003eGenerate an S3 Auth Token\u003c/h2\u003e
\u003col\u003e
\u003cli\u003e
\u003cp\u003eIn \u003cstrong\u003eAccount Home\u003c/strong\u003e, select R2\u003c/p\u003e
\u003c/li\u003e
\u003cli\u003e
\u003cp\u003eSelect \u003cstrong\u003eManage R2 API Tokens\u003c/strong\u003e on the right side of the dashboard\u003c/p\u003e
\u003c/li\u003e
\u003cli\u003e
\u003cp\u003eSelect \u003cstrong\u003eCreate API token\u003c/strong\u003e\u003c/p\u003e
\u003c/li\u003e
\u003cli\u003e
\u003cp\u003eSelect the pencil icon or R2 Token text to edit your API token name.\u003c/p\u003e
\u003c/li\u003e
\u003cli\u003e
\u003cp\u003eUnder Permissions, select \u003cstrong\u003eEdit: Allow edit access of all objects and List, Write, and Delete operations of all buckets\u003c/strong\u003e\u003c/p\u003e
\u003c/li\u003e
\u003cli\u003e
\u003cp\u003eSelect \u003cstrong\u003eCreate API Token\u003c/strong\u003e.\u003c/p\u003e
\u003c/li\u003e
\u003cli\u003e
\u003cp\u003eAfter your token has been successfully created, review your \u003cstrong\u003eSecret Access Key\u003c/strong\u003e and \u003cstrong\u003eAccess Key ID values\u003c/strong\u003e.
⚠️ \u003cem\u003eYou will not be able to access your Secret Access Key again after this step. Copy and record both values to avoid losing them.\u003c/em\u003e\u003c/p\u003e
\u003c/li\u003e
\u003cli\u003e
\u003cp\u003eThe S3 endpoint is available via \u003ccode\u003ehttps://{account_id}.r2.cloudflarestorage.com\u003c/code\u003e endpoint\u003c/p\u003e
\u003c/li\u003e
\u003c/ol\u003e
...
\u003col\u003e
\u003cli\u003e
\u003cp\u003eThe first exposes your bucket as a custom domain under your control.\u003c/p\u003e
\u003c/li\u003e
\u003cli\u003e
\u003cp\u003eThe second exposes your bucket as a Cloudflare-managed subdomain under \u003ca href="https://r2.dev"\u003ehttps://r2.dev\u003c/a\u003e.\u003c/p\u003e
\u003c/li\u003e
\u003c/ol\u003e
\u003cp\u003eThe easiest to use for testing purposes is a managed subdomain which can be setup as follows:\u003c/p\u003e
\u003col\u003e
\u003cli\u003e
\u003cp\u003eLog in to the Cloudflare dashboard \u0026gt; select your account \u0026gt; R2\u003c/p\u003e
\u003c/li\u003e
\u003cli\u003e
\u003cp\u003eIn R2, select the bucket you want to use for streaming\u003c/p\u003e
\u003c/li\u003e
\u003cli\u003e
\u003cp\u003eGo to \u003cstrong\u003eSettings\u003c/strong\u003e.\u003c/p\u003e
\u003c/li\u003e
\u003cli\u003e
\u003cp\u003eIn Settings, go to \u003cstrong\u003eBucket Accesss\u003c/strong\u003e.\u003c/p\u003e
\u003c/li\u003e
\u003cli\u003e
\u003cp\u003eUnder Bucket Access, select \u003cstrong\u003eAllow Access\u003c/strong\u003e\u003c/p\u003e
\u003c/li\u003e
\u003cli\u003e
\u003cp\u003eAfter confirming your choice in the prompt, you can now access the bucket the bucket using the Public Bucket URL. \u003ccode\u003ehttps://pub-\u0026lt;HASH-KEY\u0026gt;.r2.dev\u003c/code\u003e\u003c/p\u003e
\u003c/li\u003e
\u003c/ol\u003e
\u003ch2 id="configure-owncast"\u003eConfigure Owncast\u003c/h2\u003e
...
\u003cli\u003eServing Endpoint: URL you created when enabling public access to your R2 bucket, e.g. \u003ccode\u003e\u0026quot;https://pub-\u0026lt;Hash-Key\u0026gt;.r2.dev\u0026quot;\u003c/code\u003e if you are using managed subdomain. ⚠️ \u003cem\u003e\u003cstrong\u003eMust not end with slash\u003c/strong\u003e\u003c/em\u003e\u003c/li\u003e
\u003c/ul\u003e
...
`},{id:15,href:"/docs/sslproxies/lighttpd/",title:"lighttpd",description:"lighttpd is a lightweight option for SSL proxying.",content:`\u003cp\u003e\u003ca href="https://www.lighttpd.net/"\u003elighttpd\u003c/a\u003e is a light HTTP server which can be configured as a suitable reverse proxy via the \u003ca href="https://redmine.lighttpd.net/projects/lighttpd/wiki/Mod_proxy"\u003emod_proxy\u003c/a\u003e module.\u003c/p\u003e
\u003ch2 id="ssl"\u003eSSL\u003c/h2\u003e
...
`},{id:18,href:"/docs/broadcasting/",title:"Broadcasting Software",description:"Welcome to Doks! This tutorial will guide you through setting up and deploying your first Doks site.",content:`\u003ch2 id="compatibility"\u003eCompatibility\u003c/h2\u003e
...
\u003c/tbody\u003e
\u003c/table\u003e
`},{id:19,href:"/docs/broadcasting/hardware/",title:"Compatible hardware",description:"Various pieces of hardware have been tested with Owncast.",content:`\u003cp\u003eThe following hardware with native live streaming have been tested and work.\u003c/p\u003e
\u003cul\u003e
...
`},{id:21,href:"/docs/sslproxies/",title:"SSL \u0026 HTTP Proxies",description:"Put your Owncast server behind a proxy to enable SSL.",content:`\u003cp\u003eWhile not required, most people will want to support SSL on a public Owncast server. If you already have a \u003ca href="https://www.cloudflare.com/learning/cdn/glossary/reverse-proxy/"\u003ereverse proxy\u003c/a\u003e that is used for SSL you can easily add Owncast to that. If you\u0026rsquo;ve never installed a proxy service before then you can quickly set one up.\u003c/p\u003e
...
`},{id:22,href:"/docs/sslproxies/sitejs/",title:"Site.js",description:"Site.js will setup Owncast with SSL as a system service.",content:`\u003cp\u003e\u003ca href="https://sitejs.org/"\u003eSite.js\u003c/a\u003e is a toolset by the \u003ca href="https://small-tech.org/"\u003eSmall Technology Foundation\u003c/a\u003e that allows you to easily setup a production web server. Additionally it can install Owncast for you, supporting \u003ca href="/docs/sslproxies/"\u003eSSL\u003c/a\u003e, configured to run \u003ca href="/docs/systemservice/"\u003eas a service\u003c/a\u003e.\u003c/p\u003e
\u003cp\u003eVisit the \u003ca href="/quickstart/sitejs"\u003einstall using Site.js\u003c/a\u003e page for more details.\u003c/p\u003e
`},{id:23,href:"/docs/chat-authentication/",title:"Chat authentication",description:"Verify your and keep your chat identity.",content:`\u003cp\u003eThere is no requirement to authenticate when using Owncast chat. However, some prefer
...
`},{id:24,href:"/docs/embed/",title:"Embedding into your site",description:"You can easily embed your chat or video into another site.",content:`\u003cdiv class="alert alert-warning d-flex" role="alert"\u003e
  \u003cdiv class="flex-shrink-1 alert-icon"\u003e💡\u003c/div\u003e
...
\u003cp\u003eHowever, if you \u003cem\u003ereally\u003c/em\u003e need the HLS feed (i.e. for sharing your stream to OpenSlides), you can access the HLS feed directly via this URL: \u003ccode\u003ehttp://your.host/hls/stream.m3u8\u003c/code\u003e.\u003c/p\u003e
...
`},{id:25,href:"/docs/notifications/",title:"Live stream notifications",description:"Send notifications when your stream goes live.",content:`\u003cp\u003eSome streams benefit from announcing to their audience when they go live.\u003c/p\u003e
...
\u003cp\u003eYou can notify your Twitter followers when your stream goes live.\u003c/p\u003e
\u003cp\u003eIt requires you to have Twitter API credentials, and Twitter does not make it easy for you to acquire those.
These steps should help you, but you may need to contact Twitter directly if you have questions.\u003c/p\u003e
\u003col\u003e
\u003cli\u003eVisit \u003ca href="https://developer.twitter.com"\u003ehttps://developer.twitter.com\u003c/a\u003e. Apply to be a developer if it prompts you to.\u003c/li\u003e
\u003cli\u003eAfter being approved visit \u0026ldquo;Projects and apps\u0026rdquo; -\u0026gt; Your project name. Create a new project if needed.\u003c/li\u003e
\u003cli\u003eGo to the \u0026ldquo;Settings\u0026rdquo; area.\u003c/li\u003e
\u003cli\u003eScroll down to \u0026ldquo;User authentication settings\u0026rdquo; and click on \u0026ldquo;Edit\u0026rdquo;.\u003c/li\u003e
\u003cli\u003eEnable OAuth 1.0a with Read/Write permissions.\u003c/li\u003e
\u003cli\u003eFill out the form with your information. Callback can be anything. Leave optional fields empty.\u003c/li\u003e
\u003cli\u003eGo to your project under the \u0026ldquo;Keys and tokens\u0026rdquo; section.\u003c/li\u003e
\u003cli\u003eGenerate API key and secret.\u003c/li\u003e
\u003cli\u003eGenerate access token and secret. Verify it says \u0026ldquo;Read and write permissions.\u0026rdquo;\u003c/li\u003e
...
\u003cp\u003eYou\u0026rsquo;ve decided you want to use as little CPU on your Owncast server as possible so you enable \u0026ldquo;Video Passthrough\u0026rdquo; mode as the only output available. This means the exact video you\u0026rsquo;re generating in your broadcasting software is what is sent to your viewers.\u003c/p\u003e
\u003cp\u003e\u003cstrong\u003eHow much bandwidth is used on your server for this stream?\u003c/strong\u003e\u003c/p\u003e
\u003ctable\u003e
\u003cthead\u003e
\u003ctr\u003e
...
\u003ch3 id="should-i-only-care-about-the-highest-quality-to-reduce-cpu-usage"\u003eShould I only care about the highest quality to reduce CPU usage?\u003c/h3\u003e
\u003cp\u003eIt\u0026rsquo;s not about you, your bandwidth, or your CPU. It\u0026rsquo;s about your viewers. If they can\u0026rsquo;t watch your stream because you didn\u0026rsquo;t have them in mind then it\u0026rsquo;s not worth streaming in the first place.\u003c/p\u003e
...
`},{id:28,href:"/docs/social/",title:"Social features",description:"Allow people to follow your server, know when you go live, share and interact with your stream.",content:`\u003cp\u003eOwncast allows people to follow, engage with your server, and share your stream with others on what is known as the Fediverse, a decentralized network of services.\u003c/p\u003e
\u003cspan class="version-support"\u003e
...
\u003c/ul\u003e
`},{id:29,href:"/docs/metrics/",title:"Stream performance",description:"It's important to know if your Owncast stream is performing well. There are a few tools within the admin to assist with this.",content:`\u003ch2 id="overall-stream-health"\u003eOverall stream health\u003c/h2\u003e
\u003cp\u003eThere\u0026rsquo;s no point streaming if nobody is able to watch it. Using the \u0026ldquo;Stream Health\u0026rdquo; screen in the admin
you can get an overview of some important metrics that may give you an idea if what you\u0026rsquo;re offering your viewers is leading
to a good experience.\u003c/p\u003e
...
\u003cp\u003e\u003cstrong\u003eNote:\u003c/strong\u003e Not all players will be represented in playback metrics as Owncast can only get detailed playback details in certain browsers, and not at all from external players (QuickTime, VLC, mpv, smart tvs, etc).\u003c/p\u003e
...
\u003c/span\u003e\u003c/span\u003e\u003c/span\u003e\u003c/code\u003e\u003c/pre\u003e\u003c/div\u003e`},{id:30,href:"/docs/moderation/",title:"Chat moderation",description:"Add moderators, remove messages and users from your chat.",content:`\u003cp\u003eUsing either the Owncast admin, or inline moderation controls within your chat, you can remove individual messages or entire users.\u003c/p\u003e
...
`},{id:31,href:"/docs/troubleshooting/",title:"Troubleshooting",description:"Some categories of issues you might run into and some next steps to help troubleshoot.",content:`\u003ch2 id="cpu-and-ram-usage-alerts"\u003eCPU and RAM usage alerts\u003c/h2\u003e
...
`},{id:32,href:"/docs/website/",title:"Web Site + Chat",description:"Customize your Owncast web page by adding additional content and links.",content:`\u003ch2 id="overview"\u003eOverview\u003c/h2\u003e
...
`},{id:33,href:"/docs/codecs/",title:"Codecs \u0026 Hardware Acceleration",description:"If you have direct access to specific hardware you may be able to increase the performance of your server by using a compatible codec.",content:`\u003cspan class="version-support"\u003e
...
\u003cp\u003eFollow the instructions on the \u003ca href="https://developer.nvidia.com/blog/nvidia-ffmpeg-transcoding-guide/"\u003eNVIDIA ffmpeg transcoding guide\u003c/a\u003e to install all the required drivers and libraries. This requires installing a driver from the \u003ca href="https://www.nvidia.com/drivers"\u003eNVIDIA website\u003c/a\u003e, Downloading and install the \u003ca href="https://developer.nvidia.com/cuda-toolkit"\u003eCUDA toolkit\u003c/a\u003e, \u003ca href="https://github.com/FFmpeg/nv-codec-headers"\u003edownloading nv-codec-headers\u003c/a\u003e, and building ffmpeg. Scroll to the section entitled \u003cem\u003eHardware accelerated transcoding with FFmpeg\u003c/em\u003e at the \u003ca href="https://developer.nvidia.com/blog/nvidia-ffmpeg-transcoding-guide/"\u003eNVIDIA transcoding guide\u003c/a\u003e for more information.\u003c/p\u003e
...
`},{id:34,href:"/docs/video/",title:"Video",description:"Configure your video to manage the quality and hardware performance.",content:`\u003cp\u003eThis document aims to outline what is being done to your content and the different knobs you can tweak to get the best output for your instance.\u003c/p\u003e
...
`},{id:35,href:"/docs/api/",title:"API Documentation",description:null,content:`\u003cp\u003eOwncast offers an API to integrate its services in other interfaces, like the \u003ca href="https://github.com/owncast/owncast-admin"\u003eOwncast Admin Panel\u003c/a\u003e.\u003c/p\u003e
...
`},{id:37,href:"/docs/directory/",title:"The Directory",description:"The Owncast Directory is a centralized list of streams for people to discover.",content:`\u003cp\u003eTo help people discover streams by people using Owncast we have an optional Owncast directory you can add yourself to.\u003c/p\u003e
\u003col\u003e
...
`},{id:38,href:"/docs/viewers/",title:"Viewer details",description:null,content:`\u003cp\u003eOwncast can display high-level geographic information about your current viewers if you enable it in your instance.\u003c/p\u003e
...
`},{id:39,href:"/docs/scaling/",title:"Scaling Owncast",description:"A place to start when needing to increase the capacity of your server.",content:`\u003ch2 id="disclaimer"\u003eDisclaimer\u003c/h2\u003e
...
`},{id:41,href:"/docs/",title:"Documentation",description:null,content:`\u003cp\u003eFor most people Owncast will be completely usable out of the box without additional configuration. Simply following the \u003ca href="/quickstart"\u003eQuickstart\u003c/a\u003e will have you streaming in minutes.\u003c/p\u003e
...
\u003c/ol\u003e
`},{id:43,href:"/docs/watching-on-tvs/",title:"Watching an Owncast Stream on Televisions",description:"The web isn't the only option for watching an Owncast stream.",content:`\u003cdiv class="alert alert-warning d-flex" role="alert"\u003e
  \u003cdiv class="flex-shrink-1 alert-icon"\u003e💡\u003c/div\u003e
