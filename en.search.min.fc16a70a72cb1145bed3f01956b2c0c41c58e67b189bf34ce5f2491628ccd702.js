...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.34f49a6fa47d03edae1b8e5aad9b55104c3026af7b541592b0b783fe73c082f5.js',function(){input.required=false;search();});}
