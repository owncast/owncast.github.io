...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f024bcd1852b3413e2b1f7f5f0563dcfd5184cd2ab8f15f81f734aafff0b22bc.js',function(){input.required=false;search();});}
