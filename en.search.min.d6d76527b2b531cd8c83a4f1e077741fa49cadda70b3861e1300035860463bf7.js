...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.89e5abe9f504ad42fe84217648428883d4bcc123f28aef8ff4d130794837cdaa.js',function(){input.required=false;search();});}
