...
Standardmäßig drücken die Zuschauer auf Play, um zu schauen. Wenn Sie möchten, dass der Stream automatisch startet, wenn jemand Ihre Seite öffnet, ändern Sie die Einstellung **Autoplay** auf derselben Videokonfigurationsseite. Es hat keine Leistungsbeeinträchtigung und es gilt für Ihre Owncast-Seite und für [eingebettete Player](/docs/embed#autoplay).

<img src="/docs/img/admin-autoplay.png" alt="Die Einstellung für Automatisches Abspielen auf der Videokonfigurationsseite im Admin zeigt das Auswahlfeld für das Verhalten" width="65%" />
