...
## 4. Can I stream copyrighted media with Owncast?

The short answer is: You should not do that. While Owncast does not scan your stream for copyrighted media like larger platforms do, rights holders can and do work with infrastructure providers like your ISP and data centers to stop the stream and get after you. If in doubt, check with copyright lawyers in your jurisdiction.
...
## 6. What kind of server do I need to run Owncast?
...
## 7. When would I need a more powerful server?
...
## 8. What are bitrates?  Why would I want more?
