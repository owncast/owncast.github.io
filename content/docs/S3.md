...
### Note: Backblaze is currently unsupported due to browser-based CORS issues. The uploaded files seem to take some time to get the correct CORS settings applied to them.  Will update this documentation when a resolution is found.

[Backblaze's B2](https://www.backblaze.com/b2/cloud-storage.html) offers 10G for free.

1. Create a new bucket on the B2 web site.
{{< img src="/docs/img/backblaze-1.png" align="center">}}

1. Take note of the _endpoint_ provided and use it in your config file for the `endpoint`.
{{< img src="/docs/img/backblaze-2.png" align="center">}}

1. Edit the _Lifecycle Settings_ to auto-delete files after 1 day.
{{< img src="/docs/img/backblaze-3.png" align="center">}}

1. Edit the [_CORS Settings_](https://www.backblaze.com/b2/docs/cors_rules.html) to allow access to your web site.
{{< img src="/docs/img/backblaze-4.png" align="center">}}

1. Create an _App Key_.  Using the `keyID` as the `accessKey` and `applicationKey` as `secret` in your owncast config file.
{{< img src="/docs/img/backblaze-5.png" align="center">}}
