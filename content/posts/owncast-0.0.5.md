...
* [`POST /api/admin/chat/updatemessagevisibility`](https://owncast.online/api/development/#tag/Admin/paths/~1api~1admin~1chat~1updatemessagevisibility/post) toggles the visibility of of messages
