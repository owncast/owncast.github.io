...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.9a132482f76a7b89783a2a85f756ae526df5e017cf0157a9da6940b23f4fe0f6.js',function(){input.required=false;search();});}
